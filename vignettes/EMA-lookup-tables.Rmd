...
devtools::load_all() #doesn't function as expected
my_tables # how you load internal data, but doesn't work well with overwriting
#utils::data("data/tables") # how to load external data
