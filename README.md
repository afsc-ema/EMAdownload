...
[![R-CMD-check](https://github.com/afsc-ema/EMAdownload/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/afsc-ema/EMAdownload/actions/workflows/R-CMD-check.yaml)
<!-- badges: end --> R package built to query and join survey data from
EMA survey datasets from AKFIN APIs. Currently catch and specimen data
are operational, with CTD and other oceanographic data to follow.
