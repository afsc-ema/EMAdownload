...
EMA survey data are nuanced, as survey design and sample processing has changed throughout the timeseries. 
Please use vignettes to see a in-progress write-up of all important data concepts.
[Introduction vignette](https://afsc-ema.github.io/EMAdownload/articles/EMAdownload_introduction.html)
```r
...
```
or view the [join event catch guide vignette](https://afsc-ema.github.io/EMAdownload/articles/join_event_catch_guide.html)
