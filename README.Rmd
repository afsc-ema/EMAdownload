...
# place holder to reference vignettess in the rmd but need to publish the package first and create github pages
#Or see the html version of this vignette
#(https://your-username.github.io/EMAdownload/articles/EMAdownload.html)
```
